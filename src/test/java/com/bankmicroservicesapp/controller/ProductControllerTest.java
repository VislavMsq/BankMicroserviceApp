...
class ProductControllerTest {
    ...
    void updateProductTest() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/product/update/by-id/60587cf0-aaa3-475a-8ef8-aa452c6e8fe9")
        ...
        mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/product/get/by-id/60587cf0-aaa3-475a-8ef8-aa452c6e8fe9")
                        .with(csrf()))
                .andReturn();
